...
public class InfantilFragment extends Fragment {
    private InfantilViewModel infantilViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        infantilViewModel =
                new ViewModelProvider(this).get(InfantilViewModel.class);
        View root = inflater.inflate(R.layout.fragment_infantil, container, false);
        final TextView textView = root.findViewById(R.id.text_infantil);
        infantilViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
